  ...
  return (
    <>
      <section className="pb-20 pt-35 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-50">
        <div className="flex justify-center mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="w-full lg:w-[70%]">
            <div className="flex flex-col items-center gap-7.5 xl:gap-12.5">
              <div className="animate_top rounded-md border border-stroke bg-white p-7.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection md:p-10 w-full">
                ...
                {/* <ul className="mb-9 flex flex-wrap gap-5 2xl:gap-7.5 justify-center">
                  <li>
